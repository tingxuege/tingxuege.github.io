...
function(t) {
    ...
    r.prototype.loadModelData = function(t, i) {
        ...
        function(t) {
            ...
            0 == Live2D.getError() ? (r.modelMatrix = new a(r.live2DModel.getCanvasWidth(), r.live2DModel.getCanvasHeight()), r.modelMatrix.setWidth(2), r.modelMatrix.setCenterPosition(0, 0), i(r.live2DModel)) : console.error("Error : Failed to loadModelData().")
        })
    },
    ...
    s.prototype.updateParam = function(t) {
        ...
        case g.STATE_CLOSING:
            (r = (e - this.stateStartTime) / this.closingMotionMsec) >= 1 && (r = 1, this.eyeState = g.STATE_CLOSED, this.stateStartTime = e),
            i = 1 - r;
            break;
        case g.STATE_CLOSED:
            (r = (e - this.stateStartTime) / this.closedMotionMsec) >= 1 && (this.eyeState = g.STATE_OPENING, this.stateStartTime = e),
            i = 0;
            break;
        case g.STATE_OPENING:
            (r = (e - this.stateStartTime) / this.openingMotionMsec) >= 1 && (r = 1, this.eyeState = g.STATE_INTERVAL, this.nextBlinkTime = this.calcNextBlink()),
            i = r;
            break;
    ...
    l.load = function(t) {
        for (var i = new l,
        e = c.getPlatformManager().jsonParseFromBytes(t).physics_hair, r = e.length, o = 0; o < r; o++) {
            var n = e[o],
            s = new PhysicsHair,
            _ = n.setup,
            ...
            for (f = 0; f < S; f++) {
                ...
                m = parseFloat(L.scale),
                T = parseFloat(L.weight),
    ...
    $.load = function(t) {
        for (var i = new $,
        e = c.getPlatformManager().jsonParseFromBytes(t).parts_visible, r = e.length, o = 0; o < r; o++) {
    ...
    $.prototype.normalizePartsOpacityGroup = function(t, i, e) {
        ...
        for (r < 0 && (r = 0, o = 1), n = 0; n < i.length; n++) if (! ((s = i[n].partsIndex) < 0)) if (r == n) t.setPartsOpacity(s, o);
        else {
...
function(t, i, e) {
    ...
    function n(t) {
        ...
        e = (u(t.clientX - i.left), p(t.clientY - i.top), o({
            x: i.left + i.width / 2,
            y: i.top + i.height * I
        },
        {
        ...
        n = $(e.y - i.top);
        d.
    default.DEBUG_MOUSE_LOG && console.log("onMouseMove device( x:" + t.clientX + " y:" + t.clientY + " ) view( x:" + r + " y:" + n + ")"),
        v.setPoint(r, n)
    }
    function s() {
        A && (A = !1),
    ...
    function a(t) {
        ...
        function(t) {
            ...
            n = $(e.y - i.top);
            d.
        default.DEBUG_MOUSE_LOG && console.log("onMouseDown device( x:" + t.clientX + " y:" + t.clientY + " ) view( x:" + r + " y:" + n + ")"),
            m.tapEvent(r, n)
        } (t);
        ...
        default.DEBUG_LOG && console.log("Mouse out Window."),
            ...
            i = window.setTimeout(_, 5e4),
            sessionStorage.setItem("SleepyTimer", i)
        }
    }
    function h(t) {
        var i = t.touches[0];
        "touchstart" == t.type ? 1 == t.touches.length && n(i) : "touchmove" == t.type ?
        function(t) {
            var i = S.getBoundingClientRect(),
            e = (u(t.clientX - i.left), p(t.clientY - i.top), o({
                x: i.left + i.width / 2,
    ...
    g = r(e(3)),
    y = e(2),
    m = (window.navigator.platform.toLowerCase(), new c.
default),
    T = !1,
    P = null,
    S = null,
    ...
    window.loadlive2d = function(t, i, e) {
        ...
        default.VIEW_LOGICAL_RIGHT,
            s = -r,
            _ = r;
            if (window.Live2D.captureFrame = !1, (L = new f.L2DViewMatrix).setScreenRect(o, n, s, _), L.setMaxScreenRect(d.
        default.VIEW_LOGICAL_MAX_LEFT, d.
        default.VIEW_LOGICAL_MAX_RIGHT, d.
        default.VIEW_LOGICAL_MAX_BOTTOM, d.
        default.VIEW_LOGICAL_MAX_TOP), L.setMaxScale(d.
        default.VIEW_MAX_SCALE), L.setMinScale(d.
        default.VIEW_MIN_SCALE), (M = new f.L2DMatrix44).multScale(1, i / e), (E = new f.L2DMatrix44).multTranslate( - i / 2, -e / 2), E.multScale(2 / i, -2 / i), P = function() {
                for (var t = ["webgl", "experimental-webgl", "webkit-3d", "moz-webgl"], i = 0; i < t.length; i++) try {
                    var e = S.getContext(t[i], {
                        premultipliedAlpha: !0
                    });
                    if (e) return e
                } catch(t) {}
                return null
            } (), (0, y.setContext)(P), !P) return console.error("Failed to create WebGL context."),
            ...
            function t() { !
                ...
                default.loadIdentity(),
                    v.update(),
                    m.setDrag(v.getX(), v.getY()),
                    P.clear(P.COLOR_BUFFER_BIT),
                    g.
                default.multMatrix(M.getArray()),
                    g.
                default.multMatrix(L.getArray()),
                    g.
                default.push();
        ...
        function() {
            ...
            i._$62 = function(t, e) {
                try {
                    ...
                    if (r = o._$ST(), o._$gr(r), r > C._$T7) throw t._$NP |= i._$4s,
            ...
            i.prototype.getModelImpl = function() {
                return null == this._$MT && (this._$MT = new h, this._$MT._$zP()),
                this._$MT
            },
            ...
            i.prototype._$P7 = function(t, i, e, r) {
                ...
                if (0 != e) if (1 == t.length) {
                    ...
                    l = e / r;
                    _ ? (h += l) > 1 && (h = 1) : (h -= l) < 0 && (h = 0),
                    this.setPartsOpacity(a, h)
                } else {
                    for (var $ = 0; $ < t.length; $++) if (s = t[$], f = 0 != this.getParamFloat(s)) {
                        if (o >= 0) break;
                        o = $,
                        a = i[$],
                        n = this.getPartsOpacity(a),
                        (n += e / r) > 1 && (n = 1)
                    }
                    for (o < 0 && (console.log("No _$wi _$q0/ _$U default[%s]", t[0]), o = 0, n = 1, this.loadParam(), this.setParamFloat(t[o], n), this.saveParam()), $ = 0; $ < t.length; $++) if (a = i[$], o == $) this.setPartsOpacity(a, n);
                    else {
                        var u, p = this.getPartsOpacity(a); (1 - (u = n < .5 ? -.5 * n / .5 + 1 : .5 * (1 - n) / .5)) * (1 - n) > .15 && (u = 1 - .15 / (1 - n)),
                        p > u && (p = u),
                        this.setPartsOpacity(a, p)
                    }
                } else for ($ = 0; $ < t.length; $++) {
                    s = t[$],
                    a = i[$];
            ...
            e.prototype.releaseShader = function() {
                for (var t = rt.frameBuffers.length,
                i = 0; i < t; i++) this.gl.deleteFramebuffer(rt.frameBuffers[i].framebuffer);
                rt.frameBuffers = [],
                rt.glContext = []
            },
            ...
            e.prototype.calcClippedDrawTotalBounds = function(t, i) {
                for (var e = t._$Ri.getModelImpl().getCanvasWidth(), r = t._$Ri.getModelImpl().getCanvasHeight(), o = e > r ? e: r, n = o, s = o, _ = 0, a = 0, h = i.clippedDrawContextList.length, l = 0; l < h; l++) {
                    ...
                    u = t._$C2($);
                    if (u._$yo()) {
                        for (var p = u.getTransformedPoints(), f = p.length, c = [], d = [], g = 0, y = F._$i2; y < f; y += F._$No) c[g] = p[y],
                        d[g] = p[y + 1],
                        g++;
            ...
            e.prototype.setupLayoutBounds = function(t) {
                ...
                r = ~~r;
                for (var o = 0,
                s = 0; s < e.CHANNEL_COUNT; s++) {
                    var _ = i + (s < r ? 1 : 0);
                    if (0 == _);
                    else if (1 == _)($ = this.clipContextList[o++]).layoutChannelNo = s,
                    $.layoutBounds.x = 0,
                    $.layoutBounds.y = 0,
                    $.layoutBounds.width = 1,
                    $.layoutBounds.height = 1;
                    else if (2 == _) for (var a = 0; a < _; a++) {
                        var h = 0;
                        l = ~~ (l = a % 2),
                        ...
                        $.layoutBounds.height = 1
                    } else if (_ <= 4) for (a = 0; a < _; a++) l = ~~ (l = a % 2),
                    h = ~~ (h = a / 2),
                    ($ = this.clipContextList[o++]).layoutChannelNo = s,
                    $.layoutBounds.x = .5 * l,
                    $.layoutBounds.y = .5 * h,
                    ...
                    else if (_ <= 9) for (a = 0; a < _; a++) {
                        var l;
                        l = ~~ (l = a % 3),
                        h = ~~ (h = a / 3);
                        var $; ($ = this.clipContextList[o++]).layoutChannelNo = s,
                        $.layoutBounds.x = l / 3,
                        $.layoutBounds.y = h / 3,
            ...
            _.getID = function(t) {
                var i = _._$tP[t];
                return null == i && (i = new _(t), _._$tP[t] = i),
                i
            },
            ...
            a.getID = function(t) {
                var i = a._$tP[t];
                return null == i && (i = new a(t), a._$tP[t] = i),
                i
            },
            ...
            (l.Src = function() {}).SRC_TO_X = "SRC_TO_X",
            l.Src.SRC_TO_Y = "SRC_TO_Y",
            l.Src.SRC_TO_G_ANGLE = "SRC_TO_G_ANGLE",
            (l.Target = function() {}).TARGET_FROM_ANGLE = "TARGET_FROM_ANGLE",
            ...
            d.prototype._$F0 = function(t) {
                ...
                this._$z0 = t._$_T(),
                this._$qT = t._$_T(),
                t.getFormatVersion() >= C.LIVE2D_FORMAT_VERSION_V2_10_SDK2 && (this.reflectX = t._$po(), this.reflectY = t._$po())
            },
            ...
            y._$Vr = function(t, i, e, r, o, n, s, _) {
                ...
                if (a <= 0) {
                    ...
                    L = T * g,
                    E = T * d;
                    for (f = 0; f < $;) n[u] = S * p[f] + v * c[f] + L * y[f] + E * m[f],
                    ++f,
                    n[u + 1] = S * p[f] + v * c[f] + L * y[f] + E * m[f],
                    ++f,
                    u += _
                } else if (3 == a) {
                    var A = o[h[0]],
                    ...
                    V = F * T * g,
                    X = F * T * d;
                    for (f = 0; f < $;) n[u] = N * A[f] + B * I[f] + G * w[f] + U * x[f] + Y * O[f] + k * D[f] + V * R[f] + X * b[f],
                    ++f,
                    n[u + 1] = N * A[f] + B * I[f] + G * w[f] + U * x[f] + Y * O[f] + k * D[f] + V * R[f] + X * b[f],
                    ++f,
                    u += _
                } else if (4 == a) {
                    var z = o[h[0]],
                    ...
                    vt = _t * F * T * g,
                    Lt = _t * F * T * d;
                    for (f = 0; f < $;) n[u] = ht * z[f] + lt * H[f] + $t * W[f] + ut * j[f] + pt * q[f] + ft * J[f] + ct * Q[f] + dt * Z[f] + gt * K[f] + yt * tt[f] + mt * it[f] + Tt * et[f] + Pt * rt[f] + St * ot[f] + vt * nt[f] + Lt * st[f],
                    ++f,
                    n[u + 1] = ht * z[f] + lt * H[f] + $t * W[f] + ut * j[f] + pt * q[f] + ft * J[f] + ct * Q[f] + dt * Z[f] + gt * K[f] + yt * tt[f] + mt * it[f] + Tt * et[f] + Pt * rt[f] + St * ot[f] + vt * nt[f] + Lt * st[f],
                    ++f,
                    u += _
                } else {
                    for (var Mt = 1 << a,
                    Et = new Float32Array(Mt), At = 0; At < Mt; At++) {
                        for (var It = At,
                        wt = 1,
                        xt = 0; xt < a; xt++) wt *= It % 2 == 0 ? 1 - l[xt] : l[xt],
                        It /= 2;
                        Et[At] = wt
                    }
                    ...
                    for (f = 0; f < $;) {
                        ...
                        bt = 0,
                        Ft = f + 1;
                        for (Dt = 0; Dt < Mt; Dt++) Rt += Et[Dt] * Ot[Dt][f],
                        bt += Et[Dt] * Ot[Dt][Ft];
                        f += 2,
                        n[u] = Rt,
                        n[u + 1] = bt,
            ...
            P.prototype._$F0 = function(t) {
                ...
                this._$Lb = t._$cS(),
                this._$mS = t._$Tb(),
                t.getFormatVersion() >= C._$T7 ? (this.clipID = t._$nP(), this.clipIDList = this.convertClipIDForV2_11(this.clipID)) : this.clipIDList = [],
                this._$MS(this._$Lb)
            },
            ...
            x.getID = function(t) {
                var i = x._$tP[t];
                return null == i && (i = new x(t), x._$tP[t] = i),
                i
            },
            ...
            O.prototype.transform = function(t, i, e) {
                ...
                default:
                    return;
                case O._$go | O._$fo | O._$gb: for (r = this._$7, o = this._$H, n = this._$k, s = this._$f, _ = this._$g, a = this._$w; --e >= 0;) {
                        var $ = t[h++],
                        u = t[h++];
                        i[l++] = r * $ + o * u + n,
                        i[l++] = s * $ + _ * u + a
                    ...
                    return;
                case O._$go | O._$fo: for (r = this._$7, o = this._$H, s = this._$f, _ = this._$g; --e >= 0;) $ = t[h++],
                    u = t[h++],
                    i[l++] = r * $ + o * u,
                    i[l++] = s * $ + _ * u;
                    return;
                case O._$go | O._$gb: for (o = this._$H, n = this._$k, s = this._$f, a = this._$w; --e >= 0;) $ = t[h++],
                    i[l++] = o * t[h++] + n,
                    i[l++] = s * $ + a;
                    return;
                case O._$go:
                    for (o = this._$H, s = this._$f; --e >= 0;) $ = t[h++],
                    i[l++] = o * t[h++],
                    i[l++] = s * $;
                    return;
                case O._$fo | O._$gb: for (r = this._$7, n = this._$k, _ = this._$g, a = this._$w; --e >= 0;) i[l++] = r * t[h++] + n,
                    i[l++] = _ * t[h++] + a;
                    return;
                case O._$fo:
                ...
                for (var o = 0; o < r; ++o) {
                    ...
                    if ("\n" != n && "\r" != n) if ("#" != n) if ("$" != n) {
                        if ("a" <= n && n <= "z" || "A" <= n && n <= "Z" || "_" == n) {
                            ...
                            if (_ >= 0) {
                                var a = new b;
                                A.startsWith(t, s, D._$cs) ? (a._$RP = b._$hs, a._$4P = new String(t, s, _ - s)) : A.startsWith(t, s, D._$ar) ? (a._$4P = new String(t, s + 7, _ - s - 7), A.startsWith(t, s + 7, "ANCHOR_X") ? a._$RP = b._$xs: A.startsWith(t, s + 7, "ANCHOR_Y") ? a._$RP = b._$us: A.startsWith(t, s + 7, "SCALE_X") ? a._$RP = b._$qs: A.startsWith(t, s + 7, "SCALE_Y") ? a._$RP = b._$Ys: A.startsWith(t, s + 7, "X") ? a._$RP = b._$ws: A.startsWith(t, s + 7, "Y") && (a._$RP = b._$Ns)) : (a._$RP = b._$Fr, a._$4P = new String(t, s, _ - s)),
                                i.motions.push(a);
                                var h = 0;
            ...
            C._$9o = function(t) {
                if (t < 40) return C._$uT(t),
                null;
                if (t < 50) return C._$uT(t),
                null;
                if (t < 60) return C._$uT(t),
                null;
                if (t < 100) switch (t) {
                case 65:
                    return new j;
            ...
            N.prototype.update = function() {
                ...
                i = 0; i < t; i++) this._$_2[i] != this._$vr[i] && (this._$Js[i] = N._$ZS, this._$vr[i] = this._$_2[i]);
                var e = this._$3S.length,
                r = this._$aS.length,
                o = V._$or(),
                s = V._$Pr() - o + 1;
                for ((null == this._$Ws || this._$Ws.length < s) && (this._$Ws = new Int16Array(s), this._$Vs = new Int16Array(s)), i = 0; i < s; i++) this._$Ws[i] = N._$V2,
                this._$Vs[i] = N._$V2;
            ...
            G.prototype._$7T = function(t) {
                ...
                switch (this._$_L) {
                case STATE_CLOSING:
                    (r = (e - this._$bb) / this._$Dr) >= 1 && (r = 1, this._$_L = vt.STATE_CLOSED, this._$bb = e),
                    i = 1 - r;
                    break;
                case STATE_CLOSED:
                    (r = (e - this._$bb) / this._$Cb) >= 1 && (this._$_L = vt.STATE_OPENING, this._$bb = e),
                    i = 0;
                    break;
                case STATE_OPENING:
                    (r = (e - this._$bb) / this._$mr) >= 1 && (r = 1, this._$_L = vt.STATE_INTERVAL, this._$12 = this._$T2()),
                    i = r;
                    break;
                case STATE_INTERVAL:
                    this._$12 < e && (this._$_L = vt.STATE_CLOSING, this._$bb = e),
                    i = 1;
                    break;
                case STATE_FIRST:
                default:
                    this._$_L = vt.STATE_INTERVAL,
                    this._$12 = this._$T2(),
                    i = 1
                }
                this._$jo || (i = -i),
            ...
            var vt = function() {};
            vt.STATE_FIRST = "STATE_FIRST",
            vt.STATE_INTERVAL = "STATE_INTERVAL",
            vt.STATE_CLOSING = "STATE_CLOSING",
            vt.STATE_CLOSED = "STATE_CLOSED",
            vt.STATE_OPENING = "STATE_OPENING",
            U.prototype = new S,
            U._$As = 32,
            U._$Gr = !1,
            U._$NT = null,
            ...
            U._$cr = function(t, i) {
                return null == t || t._$yL() < i.length ? ((t = U._$9r(2 * i.length)).put(i), t._$oT(0)) : (t.clear(), t.put(i), t._$oT(0)),
                t
            },
            U._$mb = function(t, i) {
                return null == t || t._$yL() < i.length ? ((t = U._$vb(2 * i.length)).put(i), t._$oT(0)) : (t.clear(), t.put(i), t._$oT(0)),
                t
            },
            U._$Hs = function() {
                return U._$Gr
            ...
            Y.prototype._$Nr = function(t, i) {
                ...
                if (this._$GS._$Ur(t)) {
                    ...
                    if (this._$GS._$zr(n, s, o), o <= 0) {
                        ...
                        nt = 0,
                        st = 0;
                        for (it = 0; it < j; it++) et += q[it] * tt[it]._$fL,
                        rt += q[it] * tt[it]._$gL,
                        ot += q[it] * tt[it]._$B0,
                        nt += q[it] * tt[it]._$z0,
                        st += q[it] * tt[it]._$qT;
            ...
            Y.prototype._$2b = function(t, i) {
                ...
                if (e._$hS(!0), this._$32()) {
                    ...
                    if (e._$8r == L._$ur && (e._$8r = t.getBaseDataIndex(r)), e._$8r < 0) rt._$so && n._$li("_$L _$0P _$G :: %s", r),
                    e._$hS(!1);
                    else {
            ...
            Y.prototype._$nb = function(t, i, e, r, o, n, s) {
                this != i._$GT() && console.log("### assert!! ### ");
                for (var _, a, h = i,
                l = null != h._$Wr ? h._$Wr: h._$Yr, $ = Math.sin(yt._$bS * l._$qT), u = Math.cos(yt._$bS * l._$qT), p = h.getTotalScale(), f = l.reflectX ? -1 : 1, c = l.reflectY ? -1 : 1, d = u * p * f, g = -$ * p * c, y = $ * p * f, m = u * p * c, T = l._$fL, P = l._$gL, S = o * s, v = n; v < S; v += s) _ = e[v],
                a = e[v + 1],
                r[v] = d * _ + g * a + T,
                r[v + 1] = y * _ + m * a + P
            },
            ...
            V.prototype._$F0 = function(t) {
                ...
                this._$Lb = t._$cS(),
                this._$mS = t._$Tb(),
                t.getFormatVersion() >= C._$T7 ? (this.clipID = t._$nP(), this.clipIDList = this.convertClipIDForV2_11(this.clipID)) : this.clipIDList = null,
                V._$Sb(this._$Lb)
            },
                ...
                for (var o = 0; o < r; ++o) {
                    ...
                    if ("\n" != n && "\r" != n) if ("#" != n) if ("$" != n) {
                        if (97 <= s && s <= 122 || 65 <= s && s <= 90 || "_" == n) {
                            ...
                            if (a >= 0) {
                                var h = new b;
                                A.startsWith(t, _, H._$cs) ? (h._$RP = b._$hs, h._$4P = A.createString(t, _, a - _)) : A.startsWith(t, _, H._$ar) ? (h._$4P = A.createString(t, _ + 7, a - _ - 7), A.startsWith(t, _ + 7, "ANCHOR_X") ? h._$RP = b._$xs: A.startsWith(t, _ + 7, "ANCHOR_Y") ? h._$RP = b._$us: A.startsWith(t, _ + 7, "SCALE_X") ? h._$RP = b._$qs: A.startsWith(t, _ + 7, "SCALE_Y") ? h._$RP = b._$Ys: A.startsWith(t, _ + 7, "X") ? h._$RP = b._$ws: A.startsWith(t, _ + 7, "Y") && (h._$RP = b._$Ns)) : (h._$RP = b._$Fr, h._$4P = A.createString(t, _, a - _)),
                                i.motions.push(h);
                                var l = 0,
                                $ = [];
                        ...
                        var f = !1;
                        if (a >= 0) for (a == _ + 4 && "f" == W(t, _ + 1) && "p" == W(t, _ + 2) && "s" == W(t, _ + 3) && (f = !0), o = a + 1; o < r && "\r" != (n = W(t, o)) && "\n" != n; ++o)"," != n && " " != n && "\t" != n && (u = A._$LS(t, r, o, e), e[0] > 0 && f && 5 < u && u < 121 && (i._$D0 = u), o = e[0]);
                        for (; o < r && "\n" != W(t, o) && "\r" != W(t, o); ++o);
                    } else for (; o < r && "\n" != W(t, o) && "\r" != W(t, o); ++o);
                }
                ...
                T = o; T < u; T += n) {
                    ...
                    if (v = i[T], L = i[T + 1], P = v * _, S = L * a, P < 0 || S < 0 || _ <= P || a <= S) {
                        ...
                        if ( - 2 < v && v < 3 && -2 < L && L < 3) if (v <= 0) if (L <= 0) {
                            ...
                            F = f - 2 * y,
                            C = p - 2 * c - 2 * g,
                            N = f - 2 * d - 2 * y; (B = .5 * (v - -2)) + (G = .5 * (L - -2)) <= 1 ? (e[T] = C + (b - C) * B + (D - C) * G, e[T + 1] = N + (F - N) * B + (R - N) * G) : (e[T] = x + (D - x) * (1 - B) + (b - x) * (1 - G), e[T + 1] = O + (R - O) * (1 - B) + (F - O) * (1 - G))
                        } else if (L >= 1) b = s[2 * (0 + a * M)],
                        F = s[2 * (0 + a * M) + 1],
                        C = p - 2 * c + 1 * g,
                        N = f - 2 * d + 1 * y,
                        x = p + 3 * g,
                        ...
                        } else if (1 <= v) if (L <= 0) D = s[2 * (_ + 0 * M)],
                        R = s[2 * (_ + 0 * M) + 1],
                        x = p + 3 * c,
                        O = f + 3 * d,
                        C = p + 1 * c - 2 * g,
            ...
            j.prototype.transformPoints_sdk1 = function(t, i, e, r, o, n, s) {
                ...
                d = this._$A,
                g = o * s,
                y = null != f._$hr ? f._$hr: f._$Cr, m = n; m < g; m += s) rt._$ts ? (_ = e[m], a = e[m + 1], _ < 0 ? _ = 0 : _ > 1 && (_ = 1), a < 0 ? a = 0 : a > 1 && (a = 1), _ *= c, a *= d, h = 0 | _, l = 0 | a, h > c - 1 && (h = c - 1), l > d - 1 && (l = d - 1), u = _ - h, p = a - l, $ = 2 * (h + l * (c + 1))) : (_ = e[m] * c, a = e[m + 1] * d, u = _ - (0 | _), p = a - (0 | a), $ = 2 * ((0 | _) + (0 | a) * (c + 1))),
            ...
            tt.prototype.drawElements = function(t, i, e, r, o, s, _, a) {
                try {
                    ...
                    P = 0; P < h; P += 3) {
                        ...
                        St._$ni(F, C, O, D, R - O, b - D, -(b - D), R - O, y),
                        St._$ni(w, x, M, E, A - M, I - E, -(I - E), A - M, m);
                        var z = (m[0] - y[0]) / y[1],
                        H = Math.min(O, R, F),
                        W = Math.max(O, R, F),
                        j = Math.min(D, b, C),
                        ...
                        } else rt.IGNORE_CLIP || tt.clip(u, g, s, Y, O, D, R, b, F, C, M, E, A, I, w, x),
                        rt.USE_ADJUST_TRANSLATION && (H = 0, W = l, j = 0, q = $),
            ...
            tt.clipWithTransform = function(t, i, e, r, o, s, _, a) {
                if (arguments.length < 7) n._$li("err : @LDGL.clip()");
                    ...
                    if (t.beginPath(), l) {
                        ...
                        t.lineTo(h[0], h[1])
                    } else for (t.moveTo($[2], $[3]), u = 4; u < $.length; u += 2) t.lineTo($[u], $[u + 1]);
                    t.clip()
            ...
            st.prototype.init = function(t) {
                ...
                default:
                case F._$Ms:
                    if (F._$Ls) for (var o = this._$d0 - 1; o >= 0; --o) {
                        var n = o << 1;
                ...
                try {
                    ...
                    if (!e && (V.prototype._$2b.call(this, t), this._$32())) {
                        ...
                        if (r._$8r == V._$ur && (r._$8r = t.getBaseDataIndex(o)), r._$8r < 0) rt._$so && n._$li("_$L _$0P _$G :: %s", o);
                            ...
                            _ = t._$q2(r._$8r);
                            null == s || _._$x2() ? r._$AT = !1 : (s._$nb(t, _, r._$Cr, r._$hr, this._$d0, F._$i2, F._$No), r._$AT = !0),
            ...
            lt.prototype.startMotion = function(t, i) {
                ...
                o = 0; o < r; ++o) null != (e = this.motions[o]) && (e._$qS(e._$w0.getFadeOut()), this._$eb && n._$Ji("MotionQueueManager[size:%2d]->startMotion() / start _$K _$3 (m%d)\n", r, e._$sr));
                if (null == t) return - 1; (e = new $t)._$w0 = t,
                this.motions.push(e);
                var s = e._$sr;
            ...
            lt.prototype.isFinished = function(t) {
                if (arguments.length >= 1) {
                    for (var i = 0; i < this.motions.length; i++) if (null != (e = this.motions[i]) && e._$sr == t && !e.isFinished()) return ! 1;
                    return ! 0
                }
            ...
            $t.prototype._$qS = function(t) {
                var i = M.getUserTimeMSec() + t; (this._$Do < 0 || i < this._$Do) && (this._$Do = i)
            },
            ...
            pt.getID = function(t) {
                var i = pt._$tP[t];
                return null == i && (i = new pt(t), pt._$tP[t] = i),
                i
            },
            ...
            ft._$cr = function(t, i) {
                return null == t || t._$yL() < i.length ? ((t = ft._$9r(2 * i.length)).put(i), t._$oT(0)) : (t.clear(), t.put(i), t._$oT(0)),
                t
            },
            ft._$mb = function(t, i) {
                return null == t || t._$yL() < i.length ? ((t = ft._$vb(2 * i.length)).put(i), t._$oT(0)) : (t.clear(), t.put(i), t._$oT(0)),
                t
            },
            ft._$Hs = function() {
                return this._$Gr
            ...
            ft.prototype.compileShader = function(t, i) {
                ...
                r = i,
                o = e.createShader(t);
                if (null == o) return n._$Ji("_$L0 to create shader"),
                null;
            ...
            gt.prototype._$4b = function(t) {
                ...
                if (51 == t) return i = this._$bT(),
                o = pt.getID(i);
                if (134 == t) return i = this._$bT(),
                o = _.getID(i);
                if (60 == t) return i = this._$bT(),
                o = a.getID(i);
                if (t >= 48) {
                    var e = C._$9o(t);
...
default = o;
    ...
    default.DEBUG_LOG && console.log("tapEvent view x:" + t + " y:" + i);
        for (var e = 0; e < this.models.length; e++) this.models[e].hitTest(a.
    default.HIT_AREA_HEAD, t, i) ? (a.
    default.DEBUG_LOG && console.log("Tap face."), this.models[e].setRandomExpression()) : this.models[e].hitTest(a.
    default.HIT_AREA_BODY, t, i) ? (a.
    default.DEBUG_LOG && console.log("Tap body. models[" + e + "]"), this.models[e].startRandomMotion(a.
    default.MOTION_GROUP_TAP_BODY, a.
    default.PRIORITY_NORMAL)):
        this.models[e].hitTestCustom("head", t, i) ? (a.
    default.DEBUG_LOG && console.log("Tap face."), this.models[e].startRandomMotion(a.
    default.MOTION_GROUP_FLICK_HEAD, a.
    default.PRIORITY_NORMAL)):
        this.models[e].hitTestCustom("body", t, i) && (a.
    default.DEBUG_LOG && console.log("Tap body. models[" + e + "]"), this.models[e].startRandomMotion(a.
    default.MOTION_GROUP_TAP_BODY, a.
    default.PRIORITY_NORMAL));
        return ! 0
...
default = o;
    ...
    s = r(e(11)),
    _ = r(e(1)),
    a = r(e(3)); (o.prototype = new n.L2DBaseModel).load = function(t, i, e) {
        this.setUpdating(!0),
        this.setInitialized(!1),
        this.modelHomeDir = i.substring(0, i.lastIndexOf("/") + 1),
        this.modelSetting = new s.
    default;
        var r = this; (window.location.href.includes("http://localhost:8000/") || window.location.href.includes("https://chanshiyu.com/") || window.location.href.includes("https://haremu.com/") || window.location.href.includes("https://cdn.acg.sx/") || window.location.href.includes("https://chanshiyucx.github.io/")) && this.modelSetting.loadModelSetting(i,
        function() {
    ...
    o.prototype.update = function() {
        if (null != this.live2DModel) {
            ...
            this.mainMotionManager.isFinished() && ("1" === sessionStorage.getItem("Sleepy") ? this.startRandomMotion(_.
        default.MOTION_GROUP_SLEEPY, _.
        default.PRIORITY_SLEEPY):
            this.startRandomMotion(_.
        default.MOTION_GROUP_IDLE, _.
    ...
    o.prototype.startMotion = function(t, i, e) {
        ...
        default.PRIORITY_FORCE) this.mainMotionManager.setReservePriority(e);
            else if (!this.mainMotionManager.reserveMotion(e)) return void(_.
    ...
    o.prototype.setFadeInFadeOut = function(t, i, e, r) {
        ...
        if (r.setFadeIn(this.modelSetting.getMotionFadeIn(t, i)), r.setFadeOut(this.modelSetting.getMotionFadeOut(t, i)), _.
    ...
    default.hit_areas_custom_head_y, i, e) : "body" == t && this.hitTestSimpleCustom(_.
